...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
       <form role="form" method="POST" action="master_service_handle.php" enctype="multipart/form-data">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                  ...
                  <label >Service Title </label>
                      <input name="title" required class="form-control"  placeholder="Service Title" />
                </div> 
