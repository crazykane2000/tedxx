              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <label >Product Title </label>
                      <input value="<?php echo $row_sa['product_name']; ?>" name="title" required class="form-control"  placeholder="Product Title" />
                </div> 
            
                <div class="form-group">
                  <label >Little Description</label>
                    <textarea required name="lil_desc" class="form-control" placeholder="Enter Some Details Here Too" >
                      <?php echo $row_sa['small_discription']; ?>
                    </textarea>
                </div>
            ...
            <!-- /.box-header -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input name="lil_file" type="file"  class="form-control"  placeholder="Page Title" />
                </div> 
