...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
       <form role="form" method="POST" action="master_product_handle.php" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label style="color:red" >Select Category</label>
                   ...
                   <div class="form-group">
                  <label style="color:red" >Select Sub Category</label>
                    <select name="sub_category" id="sub_category" required class="form-control">
                      <option value="">Select Category</option>                         
                    </select>
                </div>
                  ...
                  <label >Product Title </label>
                      <input name="title" required class="form-control"  placeholder="Product Title" />
                </div> 
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select name="brand" required class="form-control" >
                   <?php  
                            $ds = "SELECT brand FROM brand ORDER BY brand";
                            $result_ds = mysql_query($ds) or die(mysql_error());
                            while($row_ds = mysql_fetch_array($result_ds))
                            {
                                echo '<option>'.$row_ds['brand'].'</option>';
                            }
                        ?>
                ...
                <div class="form-group">
                  <label >Tags (Separate with commas)</label>
                      <textarea name="tag" class="form-control"   placeholder="Tags"></textarea>
                </div>
                
                  <div class="box-footer">
                <button type="submit" class="btn btn-success btn-bg">Add Page and Make it Active</button>
              </div>
...
<script src="dist/js/demo.js"></script>
  ...
  $(function () {
    ...
    $("#category").change(function(){
      var x = $("#category").val();
      $("#sub_category").load("load_sub_category.php", {var:x});
    });
