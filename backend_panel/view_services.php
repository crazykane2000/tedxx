                ...
                <?php
                    ...
                    while($row = mysql_fetch_array($result))
                    {
                       ...
                       echo '<tr>
                              ...
                              color:#fff;padding:4px;border-radius:4px">'.$row['title'].'</b></td>
...
<span style="color:red">('.$row['date'].')</span>   <br/>'.substr(strip_tags(htmlspecialchars_decode($row['description'])),0,100).'...     </td>
                             ...
                             <td><a href="delete_service.php?id='.$row['id'].'" onclick="return alert(\'Are You Sure You Want to Delete This?\');">
