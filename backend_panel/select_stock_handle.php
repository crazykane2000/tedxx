        ...
        <div class="col-xs-6">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Select Stock For sampling</h3>
            </div>
            <!-- /.box-header -->
           <form action="store_stock_handle.php" method="post" >
                 <div class="box-body" id="game">
                  ...
                  <hr/>
                  <input type="submit" value="Save Sample and Print" style="float:right" class="btn btn-success" />
                </div>  
            </form>
            <!-- /.box-body -->
          </div>
