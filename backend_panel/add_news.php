      ...
      <div class="row">
        ...
        <div class="col-md-7">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" action="master_news_handle.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label >Little Image</label>
                      <input type="file" name="file_lil" class="form-control"  placeholder="Little Image (700x400px)">
                </div>
