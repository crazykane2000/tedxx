...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>View Contact Requests : Contact Requests</title>
                ...
                <?php
                    ...
                    while($row = mysql_fetch_array($result))
                    {
                       ...
                       echo '<tr>
                              ...
                              <td><b>'.$row['email'].'</b></td>
                              <td><b style="padding:4px;background-color:green;color:#fff;border-radius:4px;">'.$row['mobile'].'</b></td>
                              <td><b>'.$row['query'].'</b></td>
                             <td><a href="delete_contact_request.php?id='.$row['id'].'" >
