...
<?php  include 'sidebar.php';  ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Career Post  <a class="btn  btn-success btn-sm" title="Add New Fee Structure" href="add_fee.php"><i class="fa  fa-black-tie"></i>  Add New</a>
        <small></small>
      </h1>
                ...
                <?php
                    ...
                    while($row = mysql_fetch_array($result))
                    {
                       ...
                       echo '<tr>
                             ...
                             <td><a href="delete_fee.php?id='.$row['id'].'" onclick="return confirm(\'Are You Sure You Want to Delete This?\');">
