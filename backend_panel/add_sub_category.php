      ...
      <div class="row">
        ...
        <div class="col-md-7">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" action="master_sub_category_handle.php" enctype="multipart/form-data">
              <div class="box-body">
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-success">Add Sub Category Of Product</button>
              </div>
            </form>
              <br/>
          </div>
