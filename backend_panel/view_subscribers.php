...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>View Subscribers Requests : Subscribers Requests</title>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Subscribers Requests</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <?php
                ...
                <?php
                    ...
                    while($row = mysql_fetch_array($result))
                    {
                       ...
                       echo '<tr>
                              <td>'.$i.' </td>
                              <td><b>'.$row['email'].'</b></td>
                              <td><a href="delete_subscribers_request.php?id='.$row['id'].'" >
