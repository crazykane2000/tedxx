        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Master Of Tea Grade</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <?php
              ...
              <table id="example1" class="table table-bordered table-striped" style="font-size:12px;">
                ...
                <tbody>
                <?php
                    $sql = "SELECT * FROM `master_grade` ORDER BY `date` DESC";    
                    ...
                    while($row = mysql_fetch_array($result))
                    {
                       ...
                       echo '<tr>
                             ...
                             <td><a href="delete_master_grade.php?id='.$row['id'].'" onclick="return alert("Are You Sure You Want to Delete This?");">
