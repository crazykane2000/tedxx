...
<?php  include 'sidebar.php';  ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        View Sample Details(<span id="kant" onclick='printDiv();'>Print</span>)
        <small></small>
      </h1>
            ...
            <?php
              ...
              ?>
                 ...
                 <div class="box-body portrait" id="game" >
                    ...
                    <label>Sample No.</label> : <?php echo "ORD".$rows['id']; ?><br/>
                  ...
                  <hr/>
                    ...
                    <a target="_blank" href="demo.php?id=<?php echo $_REQUEST['id']; ?>" >
                     ...
                     <a target="_blank" href="sticker.php?id=<?php echo $_REQUEST['id']; ?>" >
                       <button  style="float:left" class="btn btn-info" id="byu" >Print Stickers</button></a>
                </div>  
