...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>View Master : Quality</title>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Master Of Quality</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <?php
              ...
              <table id="example1" class="table table-bordered table-striped" style="font-size:12px;">
                ...
                <tbody>
                <?php
                    $sql = "SELECT * FROM `master_quality`";    
                    ...
                    while($row = mysql_fetch_array($result))
                    {
                       ...
                       echo '<tr>
                              ...
                              color:#fff;padding:4px;border-radius:4px">'.$row['quality'].'</b></td>
                              <td><b style="background-color:'.$row['color'].';
                              color:#fff;padding:4px;border-radius:4px">'.$row['color'].'</b></td>
                               <td><a href="delete_master_quality.php?id='.$row['id'].'" onclick="return alert("Are You Sure You Want to Delete This?");">
                              <button  class="btn btn-xs btn-danger"><i class="fa fa-fw fa-times"></i></button></a>
                              <a href="update_master_quality.php?id='.$row['id'].'">
