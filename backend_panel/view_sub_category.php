        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">View Sub Categories</h3>
            </div>
            <!-- /.box-header -->
              ...
              <table id="example1" class="table table-bordered table-striped" style="font-family:calibri;font-size:14px;">
                ...
                <?php
                    ...
                    while($row = mysql_fetch_array($result))
                    {
                       echo '<tr style="">
                                <td>'.$i.'</td>
                                <td><b style="background-color:green;color:#fff;padding:4px;border-radius:4px">'.$row['sub_category'].'</b></td>
                                <td>'.$row['category'].'</td> 
                                <td><a href="delete_sub_category.php?id='.$row['id'].'" onclick="return alert(\'Are You Sure You Want to Delete This?\');">
