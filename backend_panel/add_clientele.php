        ...
        <div class="col-md-7">
          ...
          <div class="box box-primary">
           ...
           <div style="padding:20px;">
               <form role="form" method="POST" action="master_client_handle.php" enctype="multipart/form-data">
             
                <div class="form-group">
                  <label >Client Name</label>
                  <input type="text" name="title" class="form-control"  placeholder="Client Name">
                </div>
            
                <div class="form-group">
                  <label >Image Logo</label>
                  <input type="file" name="file" class="form-control"  placeholder="Logo Image">
                </div>
