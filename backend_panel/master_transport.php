        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Transport Master</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" action="master_transport_handle.php">
              <div class="box-body">
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-success">Add New Transport</button>
              </div>
            </form>
              <br/>
          </div>
