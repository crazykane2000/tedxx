...
<?php  include 'sidebar.php';  ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Work Types <a class="btn  btn-success btn-sm" title="Add New Work" href="add_work_images.php"><i class="fa  fa-black-tie"></i>  Add New</a>
        <small></small>
      </h1>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped" style="font-size:14px;font-family:calibri">
                ...
                <tbody>
                <?php
                    $sql = "SELECT * FROM `work_images` ORDER BY `date` DESC";    
                    ...
                    while($row = mysql_fetch_array($result))
                    {
                       ...
                       // print_r($row);
                       echo '<tr>
                              <td> <b style="background-color:red;color:#fff;padding:4px;border-radius:4px">'.$row['category'].'</b></td>
                               <td><img src="../work/opt/'.$row['files'].'" style="width:40px" /></td>
                              <td><b>'.$row['date'].'</b> </td>
                              
                             <td><a href="delete_work_image.php?id='.$row['id'].'" onclick="return alert("Are You Sure You Want to Delete This?");">
