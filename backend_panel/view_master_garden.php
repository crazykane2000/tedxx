...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>View Master : Garden</title>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Master Of Garden</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <?php
              ...
              <table id="example1" class="table table-bordered table-striped" style="font-size:12px;">
                ...
                <tbody>
                <?php
                    $sql = "SELECT * FROM `master_garden` ORDER BY `id` DESC";    
                    ...
                    while($row = mysql_fetch_array($result))
                    {
                       ...
                       echo '<tr>
                              ...
                              color:#fff;padding:4px;border-radius:4px">'.$row['mark'].'</b></td>
                              <td><b style="background-color:#6b8405;
                              color:#fff;padding:4px;border-radius:4px">'.$row['name'].'</b></td>
                              <td><b style="background-color:#6b8405;
                              color:#fff;padding:4px;border-radius:4px">'.$row['garden_name'].'</b></td>
                              <td><a href="delete_master_garden.php?id='.$row['id'].'" onclick="return alert("Are You Sure You Want to Delete This?");">
                              <button  class="btn btn-xs btn-danger"><i class="fa fa-fw fa-times"></i></button></a>
                              <a href="update_master_garden.php?id='.$row['id'].'">
