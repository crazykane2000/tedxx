...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>View Career Posts : Career Posts</title>
...
<?php  include 'sidebar.php';  ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Career Post  <a class="btn  btn-success btn-sm" title="Add New Career Post" href="add_career.php"><i class="fa  fa-black-tie"></i>  Add New</a>
        <small></small>
      </h1>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Career Post</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <?php
              ...
              <table id="example1" class="table table-bordered table-striped" style="font-size:14px;font-family:calibri">
                ...
                <?php
                    ...
                    while($row = mysql_fetch_array($result))
                    {
                       ...
                       echo '<tr>
                              <td>'.$row['id'].' </td>
                              <td><b>'.$row['title_post'].'</b><br/>
                              <p>'.substr(strip_tags(htmlspecialchars_decode($row['description'])), 0, 100).'</p>
                              </td>
                              <td><b>'.$row['location'].'</b></td>
                              <td><b>'.$row['tags'].'</b></td>
                             
                             <td><a href="delete_career_post.php?id='.$row['id'].'" onclick="return alert("Are You Sure You Want to Delete This?");">
