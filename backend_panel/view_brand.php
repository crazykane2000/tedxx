              ...
              <table id="example1" class="table table-bordered table-striped" style="font-family:calibri;font-size:14px;">
                ...
                <?php
                    ...
                    while($row = mysql_fetch_array($result))
                    {
                       echo '<tr style="">
                                <td>'.$i.'</td>
                                <td><b style="background-color:green;color:#fff;padding:4px;border-radius:4px">'.$row['brand'].'</b></td>
                                <td>'.$row['date'].'</td> 
                                <td><a href="delete_brand.php?id='.$row['id'].'" onclick="return alert(\'Are You Sure You Want to Delete This?\');">
