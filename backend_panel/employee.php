...
<?php  include 'sidebar.php';  ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Employee <a class="btn  btn-success btn-sm" title="Add New People" href="add_vendor.php"><i class="fa  fa-black-tie"></i>  Add New</a>
        <small></small>
      </h1>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped" style="font-size:14px;font-family:calibri">
                ...
                <tbody>
                <?php
                    $sql = "SELECT * FROM `master_people` WHERE type='Employee' ORDER BY `type` DESC";    
