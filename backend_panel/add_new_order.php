          ...
          <div class="box">
            ...
            <div class="box-body" style="overflow-x:scroll" id="game">
              ...
              <table id="example1" class="table table-bordered table-striped" style="font-family:calibri;font-size:14px;">
                ...
                <?php
                       $i=1;
                       $sql = "SELECT * FROM `store_order` ORDER BY date DESC";
                       ...
                       while($row = mysql_fetch_array($result))
                       {
                           ...
                           $balance = "20";
                            echo '<tr style="border-bottom:solid 1px #ccc">
                              ...
                              color:#fff;padding:4px;border-radius:4px">ORD '.$row['id'].'</b></td>
                              ...
                              <a href="add_new_order_handle.php?id='.$row['id'].'">
                              <button  class="btn btn-xs btn-primary"><i class="fa fa-fw fa-eye"></i>Select </button></a>
                              </td>
                            </tr>';
                           $i++;
                       }
