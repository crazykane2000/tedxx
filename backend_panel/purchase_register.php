      ...
      <div class="row" style="min-height:800px">
        ...
        <div class="col-md-4">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" action="purchase_register_handle.php">
              <div class="box-body">
                <div class="form-group">
                    <label>Party Name</label>
                    <select class="form-control select2" name="party_name" style="width: 100%;" required>
                      <option value="">Consignor  Name</option>
                      <?php
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" name="purchase_date" id="datepicker">
                </div>
                <!-- /.input group -->
              </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                  <label>Q. Bags</label>
                  <input type="text" name="qty_bags" class="form-control"  placeholder="Quantity Bags">
                </div>
                  
                <div class="form-group">
                  <label>Qty. Per Bag</label>
                  <input type="text" name="qty_per_bag" class="form-control"  placeholder="Quantity Per Bag">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="trans_builty_no" class="form-control"  placeholder="Transport Builty Number">
                </div>
               ...
               <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" name="transport_status_date" id="datepicker1">
                </div>
                <!-- /.input group -->
              </div>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="purchase_sample" style="width: 100%;" >
                      <option >Yes</option>
                      <option>No</option>
                    </select>
                 </div>
                   ...
                   <div class="form-group">
                    ...
                    <select class="form-control" name="bag_sample" style="width: 100%;" >
                      <option >Yes</option>
                      <option>No</option>
                    </select>
                 </div>
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" name="bill_date" placeholder="Bill Date" id="datepicker2">
                </div>
                <!-- /.input group -->
              </div>
