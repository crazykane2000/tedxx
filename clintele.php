<html lang="en">
  ...
  <div style="background-image:url('img/slide_strip.jpg');padding:10px">
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                <h1 class="headsl" style="color:#fff;font-size:30px;">Our Clientele </h1>
    ...
    <div style="padding:30px;"></div>
      <div class="container">
        ...
        <br><span>We at, CTG Security Solutions™ ,are based in Amritsar,Punjab(India) – a leading provider of IT Security  Services and Training to the Industries/Companies/Corporations and aspiring IT Security Professionals. Founded on 25th May,2008 headed by Ajay Anand, a leading IT Security Professional and Trainer.</span>    
        <hr>
      </div>
      ...
      <div class="container">
        ...
        <div class="row">
            <div class="col-sm-2">
                <img src="img/amaraja.jpg" style="width:100%" />
            </div>  
            
            <div class="col-sm-2">
                <img src="img/honda.jpg" style="width:100%" />
            </div>  
            
            <div class="col-sm-2">
                <img src="img/kirloskar.jpg" style="width:100%" />
            </div>  
            
            <div class="col-sm-2">
                <img src="img/hcl.jpg" style="width:100%" />
            </div>  
            
            <div class="col-sm-2">
                <img src="img/tat_green.jpg" style="width:100%" />
            </div>  
