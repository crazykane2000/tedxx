<html lang="en">
    ...
    <?php 
        $gty = "SELECT * FROM product WHERE category='".clean(base64_decode($_REQUEST['category_title']))."'";
        //echo $gty;
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                ...
                <p style="color:#fff">Divine Engineering&trade; is an ISO 9001:2008 Certified
                </p>
            </div>
        </div>
    </div>
      ...
      <div style="padding:20px;"></div>
        <div class="container">
         <strong style="font-size:20px;">Divine serves leading private organizations, government organizations and help them in the improvement of their performance of their construction quality with our innovative and new technological products.</strong>
      ...
      <div class="container">
        <div class="row">
          <?php 
          $gty = "SELECT * FROM sub_category WHERE category ='".base64_decode($_REQUEST['category_title'])."'";
          $i=0;
          $result_gty = mysql_query($gty) or die(mysql_error());
          while($row_cf = mysql_fetch_array($result_gty)){
          
          $gogo = "SELECT * FROM product WHERE sub_category='".$row_cf['sub_category']."'";
          $result_gogo = mysql_query($gogo) or die("error hogaya");
          $row_gogo = mysql_fetch_assoc($result_gogo);
          ...
          if($i%4==0){
            ...
            echo '<div class="col-sm-3">
                    <div style="padding: 10px;background-color: #fff;">
                      <div><a href="sub_product_inner.php?id='.clean($row_cf['sub_category']).'"><img class="filter" src="page/thumb/'.$row_gogo['file'].'" style="width:100%"></a></div>
                      <br/>
                      <div style="font-size:20px;line-height:24px;color:#006df0">'.$row_gogo['sub_category'].'</div>
                      <p style="font-size: 12px;color:#888">'.$row_gogo['category'].'</p>
                    </div>
                  </div>';
                $i++;
          }
